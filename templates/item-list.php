<?php
/**
 * List Item Template for Job Board
 */
...
<article class="crelate-job-item" data-job-id="<?php echo esc_attr($post_id); ?>">
    
    <div class="crelate-job-item-header">
        <div class="crelate-job-title-section">
            ...
            <div class="crelate-job-badges">
                <?php if ($is_remote): ?>
                <span class="crelate-badge crelate-badge-remote">
                    <?php echo $templates->get_icon('remote'); ?>
                    <?php _e('Remote', 'crelate-job-board'); ?>
                </span>
                <?php endif; ?>
                
                <?php if ($is_expired): ?>
                <span class="crelate-badge crelate-badge-expired">
                    <?php _e('Expired', 'crelate-job-board'); ?>
                </span>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="crelate-job-item-body">
        ...
        <div class="crelate-job-meta-list">
            ...
            <div class="crelate-job-meta">
                ...
                <span class="crelate-job-date"><?php echo get_the_date(); ?></span>
            </div>
            <?php endif; ?>
        </div>
        <?php endif; ?>
