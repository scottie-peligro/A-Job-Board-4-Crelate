...
<div class="crelate-job-board crelate-grid-template">
    ...
    <div class="crelate-jobs-container">
        ...
        $grid_columns = $styling_settings['grid_columns'] ?? 'auto';
        $grid_class = 'crelate-jobs-grid';
        if ($grid_columns !== 'auto') {
            $grid_class .= ' columns-' . $grid_columns;
        }
        ?>
        <div class="<?php echo esc_attr($grid_class); ?>" id="crelate-jobs-grid">
            
            <?php if ($jobs->have_posts()): ?>
                <?php while ($jobs->have_posts()): $jobs->the_post(); ?>
                    <?php $templates->render_job_item('grid'); ?>
                <?php endwhile; ?>
            <?php else: ?>
